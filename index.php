...
// Preview route (must come before dynamic :publicId routes)
$router->post('/preview', [PageController::class, 'preview']);
...
$router->put('/api/auth/password', [AuthApiController::class, 'changePassword']);
